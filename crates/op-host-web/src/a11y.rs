...
fn property_focus_label(focus: PropertyFocus) -> String {
    match focus {
        ...
        PropertyFocus::WidgetPlaceholder => "Placeholder".to_string(),
        PropertyFocus::WidgetValue => "Value".to_string(),
        PropertyFocus::WidgetLabel => "Label".to_string(),
        PropertyFocus::WidgetLeadingIcon => "Leading icon".to_string(),
        PropertyFocus::WidgetTrailingIcon => "Trailing icon".to_string(),
        PropertyFocus::WidgetBindKey => "Bind value".to_string(),
        PropertyFocus::WidgetMin => "Minimum".to_string(),
        PropertyFocus::WidgetMax => "Maximum".to_string(),
        PropertyFocus::WidgetStep => "Step".to_string(),
    }
}
