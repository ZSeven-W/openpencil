...
impl CollabJwksFetcher for NativeCollabJwksFetcher {
    ...
    fn fetch_cancellable(
        ...
        op_host_services::chat_runtime::block_on_anywhere(self.fetch_async(request, cancelled))
    }
}
...
mod tests {
    ...
    fn cancellation_drops_an_in_flight_fetch_future_without_detaching() {
        ...
        let worker = std::thread::spawn(move || {
            ...
            let result = op_host_services::chat_runtime::block_on_anywhere(await_or_cancel(
                pending_fetch,
