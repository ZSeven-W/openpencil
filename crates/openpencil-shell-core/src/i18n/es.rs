...
pub fn lookup(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "git.picker.empty.body" => {
            "El panel de Git necesita al menos un archivo .op para funcionar."
        }
        ...
        "git.header.authorMissingWarning" => {
            "Configura el autor del commit para registrar la atribución"
        }
        ...
        "git.wizard.clone.error.auth-failed" => {
            "La autenticación falló. Comprueba tu usuario y token."
        }
        "git.wizard.clone.error.clone-target-exists" => {
            "La carpeta de destino ya existe o no está vacía."
        }
        "git.pull.label" => "Pull",
        ...
        "builtin.description" => {
            "Configure las claves API directamente — sin herramientas CLI necesarias."
        }
