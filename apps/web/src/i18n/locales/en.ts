const en = {
  ...
  'figma.selectLayers': 'Select layers to import',
  'figma.selectedLayers': '{{selected}} / {{total}} selected',
  'figma.importSelected': 'Import selected',
  'figma.clearSelection': 'Clear',
  'figma.backToPages': 'Pages',
  ...
  'codePanel.step.qualityCheck': 'Quality check',
  'codePanel.step.repair': 'Auto repair',
  'codePanel.step.finalValidation': 'Final validation',
  ...
  'codePanel.history.quality.passed': 'quality passed',
  'codePanel.history.quality.repaired': 'auto repaired',
  'codePanel.history.quality.degraded': 'quality degraded',
  'codePanel.history.quality.failed': 'quality failed',
  ...
  'codePanel.quality.passed': 'Quality passed',
  'codePanel.quality.repaired': 'Auto repaired',
  'codePanel.quality.degraded': 'Quality degraded',
  'codePanel.quality.failed': 'Quality failed',
  'codePanel.quality.totalTime': '{{ms}} ms',
  'codePanel.quality.repairAttempts': '{{count}} repairs',
  'codePanel.quality.issueSummary': '{{errors}} errors · {{warnings}} warnings',
  'codePanel.quality.repairDetails': 'Repair details',
  'codePanel.history.repairIssues': 'repair issues: {{issues}}',
  ...
  'cloudLibrary.dialog.description': 'Submit this form to sync the change to your cloud library.',
  ...
  'tasks.notificationRecords': 'Notification records',
  'tasks.notificationRecordsSubtitle': 'Review all background task notifications.',
  'tasks.viewAllNotifications': 'View all notifications',
  'tasks.deleteNotification': 'Delete notification',
  ...
  'tasks.retry': 'Retry',
  'tasks.resumeFromFailedStage': 'Resume failed stage',
  'tasks.rerunStep': 'Rerun step',
  'tasks.rerunChunkStep': 'Rerun chunk',
  'tasks.chunkResumeHint': 'This will rerun chunk {{chunkId}} and reuse the other completed chunks.',
  ...
  'tasks.detailDescription': 'Inspect task execution progress, steps, events, and output metadata.',
  ...
  'tasks.timingBreakdown': 'Timing breakdown',
  'tasks.timingBreakdownHint': 'Use this to locate slow planning, generation, repair, or provider time.',
  'tasks.timing.planning': 'Planning',
  'tasks.timing.chunk': 'Chunk generation',
  'tasks.timing.assembly': 'Assembly',
  'tasks.timing.qualityCheck': 'Quality check',
  'tasks.timing.repair': 'Repair',
  'tasks.timing.provider': 'Provider total',
  'tasks.timing.providerCalls': 'Provider call total',
  'tasks.timing.total': 'Total',
  'tasks.timingInsights': 'Bottleneck insights',
  'tasks.timingInsight.providerDominant': 'Provider calls account for {{percent}}% of total time.',
  'tasks.timingInsight.repairSlow':
    'Repair took {{duration}}. Check repair prompt size and issue count.',
  'tasks.timingInsight.slowestStage': '{{stage}} is the slowest stage at {{duration}}.',
  'tasks.stageArtifacts': 'Stage artifacts',
  'tasks.stageArtifactsHint': 'Inspect saved checkpoints used by resume and rerun actions.',
  'tasks.stageArtifactsEmpty': 'No stage artifacts have been saved yet.',
  'tasks.stageArtifactCount': '{{count}} artifacts',
  'tasks.stageArtifact.planning': 'planning chunks {{chunks}}',
  'tasks.stageArtifact.chunk': 'chunk: {{chunkId}}',
  'tasks.stageArtifact.assembly': 'assembly files {{files}}',
  'tasks.stageArtifact.quality': 'quality: {{status}} · errors {{errors}} · warnings {{warnings}}',
  'tasks.stageArtifact.repair': 'repair attempt {{attempt}}',
  'tasks.qualityReport': 'Quality report',
  'tasks.quality.files': 'Files',
  'tasks.quality.errors': 'Errors',
  'tasks.quality.warnings': 'Warnings',
  'tasks.quality.missingText': 'Missing text',
  'tasks.quality.missingAssets': 'Missing assets',
  'tasks.qualityIssuesEmpty': 'No quality issues.',
  'tasks.qualityMoreIssues': '{{count}} more issues',
  'tasks.qualityWarnings': 'Quality warnings',
  'tasks.qualityWarningsHint': 'Passed reports can still contain warnings worth reviewing.',
  'tasks.qualityWarningsNoDetails': 'Warning details were not saved.',
  'tasks.repairAttempts': 'Repair attempts',
  'tasks.repairDuration': '{{ms}} ms',
  'tasks.repairIssuesEmpty': 'No repair issues recorded.',
  'tasks.events': 'Events',
  ...
  'tasks.executionSummary': 'Execution summary',
  'tasks.executionSubtitle': 'Created {{createdAt}}, last updated {{updatedAt}}',
  'tasks.executionDuration': 'Execution time',
  'tasks.startedAt': 'Started',
  'tasks.completedAt': 'Completed',
  'tasks.progress': 'Progress',
  'tasks.progressPercent': '{{progress}}%',
  'tasks.stepAttempt': 'Attempt {{attempt}}',
  'tasks.stepInput': 'Input',
  'tasks.stepOutput': 'Output',
  'tasks.jobKindLabel': 'Task type',
  'tasks.jobKind.full_generation': 'Full generation',
  'tasks.jobKind.patch_generation': 'AI patch',
  'tasks.pipelineModeLabel': 'Generation path',
  'tasks.pipeline.direct_generation': 'Direct Generation',
  'tasks.pipeline.full_pipeline': 'Full Pipeline',
  'tasks.pipeline.unknown': 'Unknown',
  'tasks.baseGenerationId': 'Base generation ID',
  'tasks.patchInstruction': 'Patch instruction',
  'tasks.fileLibrary': 'File library',
  'tasks.page': 'Page',
  ...
  'tasks.table.file': 'File',
  'tasks.table.page': 'Page',
  ...
  'tasks.error.resume': 'Failed to resume task',
  'tasks.error.rerunStep': 'Failed to rerun task step',
  ...
  'tasks.agent.quality_check': 'Quality check',
  'tasks.agent.repair': 'Auto repair',
  'tasks.agent.final_validation': 'Final validation',
  ...
  'tasks.event.resume_queued': 'Resume queued',
  'tasks.event.stage_rerun_queued': 'Stage rerun queued',
  ...
  'tasks.notification.open': 'View notification',
  'tasks.confirm.deleteTask': 'Delete this task record? This will not delete the generated file.',
  'tasks.confirm.deleteNotification': 'Delete this notification record?',

  // ── Workbench ──
  'workbench.productLine': 'Design asset workbench',
  'workbench.newDesign': 'New design',
  'workbench.notifications': 'Notifications',
  'workbench.userMenu': 'Account menu',
  'workbench.accountStatus': 'Cloud account connected',
  'workbench.queueHealth': 'Queue status',
  'workbench.queueHint': 'Background generation, notifications, and workers are managed here.',
  'workbench.viewAll': 'View all',
  'workbench.open': 'Open',
  'workbench.unread': 'Unread',
  'workbench.nav.workspace': 'Workspace',
  'workbench.nav.operations': 'Operations',
  'workbench.nav.home': 'Start',
  'workbench.nav.cloud': 'Cloud library',
  'workbench.nav.tasks': 'Tasks',
  'workbench.nav.notifications': 'Notifications',
  'workbench.nav.workers': 'Worker management',
  'workbench.nav.providers': 'Provider config',
  'workbench.nav.audit': 'Audit records',
  'workbench.nav.auth': 'Auth and config',
  'workbench.command.open': 'Open command entry',
  'workbench.command.title': 'Switch workbench view',
  'workbench.command.description': 'Search and open non-editor workbench pages.',
  'workbench.command.placeholder': 'Search pages or actions...',
  'workbench.command.empty': 'No matches',
  'workbench.command.group': 'Pages',
  'workbench.command.home': 'Overview',
  'workbench.command.cloud': 'Files, projects, and folders',
  'workbench.command.tasks': 'Background task list',
  'workbench.command.notifications': 'Full notification records',
  'workbench.command.workers': 'Worker heartbeats and queue',
  'workbench.command.providers': 'Provider rate limits',
  'workbench.command.audit': 'Config change audit',
  'workbench.command.auth': 'Login and Supabase status',
  'workbench.home.title': 'Workbench',
  'workbench.home.description': 'Review design files, background tasks, notifications, and queue health.',
  'workbench.home.metric.files': 'Cloud files',
  'workbench.home.metric.filesDetail': 'Visible files in the current library',
  'workbench.home.metric.tasks': 'Background tasks',
  'workbench.home.metric.tasksDetail': 'Total in the recent task list',
  'workbench.home.metric.unread': 'Unread notifications',
  'workbench.home.metric.unreadDetail': 'Recent background task notices',
  'workbench.home.metric.workers': 'Active workers',
  'workbench.home.metric.workersDetail': '{{total}} workers reported',
  'workbench.home.recentFiles': 'Recent files',
  'workbench.home.recentFilesDescription': 'Continue cloud design asset work.',
  'workbench.home.queueHealth': 'Queue health',
  'workbench.home.queueHealthDescription': 'Background generation queue and worker runtime.',
  'workbench.home.recentTasks': 'Recent tasks',
  'workbench.home.recentTasksDescription': 'Click a task row to inspect the side sheet.',
  'workbench.home.notificationsDescription': 'Only recent items are shown here; full history is in notifications.',
