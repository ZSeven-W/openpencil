...
export const ELEMENT_SHIMS: Record<string, ElementShim> = {
  ...
  add_icon_button_v1: wrap<IconButtonV1Params>(buildIconButtonV1),
  add_image_placeholder_v1: wrap<ImagePlaceholderV1Params>(buildImagePlaceholderV1),
  add_inbox_message_v1: wrap<InboxMessageV1Params>(buildInboxMessageV1),
  add_inline_action_v1: wrap<InlineActionV1Params>(buildInlineActionV1),
  add_input_with_action_v1: wrap<InputWithActionV1Params>(buildInputWithActionV1),
  add_invite_row_v1: wrap<InviteRowV1Params>(buildInviteRowV1),
  add_kbd_v1: wrap<KbdV1Params>(buildKbdV1),
  add_legend_item_v1: wrap<LegendItemV1Params>(buildLegendItemV1),
  add_link_v1: wrap<LinkV1Params>(buildLinkV1),
  add_list_row_v1: wrap<ListRowV1Params>(buildListRowV1),
  add_metric_comparison_v1: wrap<MetricComparisonV1Params>(buildMetricComparisonV1),
  add_metric_row_v1: wrap<MetricRowV1Params>(buildMetricRowV1),
  add_nav_chip_row_v1: wrap<NavChipRowV1Params>(buildNavChipRowV1),
  add_notification_row_v1: wrap<NotificationRowV1Params>(buildNotificationRowV1),
  add_otp_input_v1: wrap<OtpInputV1Params>(buildOtpInputV1),
  add_pagination_v1: wrap<PaginationV1Params>(buildPaginationV1),
  add_phone_input_v1: wrap<PhoneInputV1Params>(buildPhoneInputV1),
  add_price_v1: wrap<PriceV1Params>(buildPriceV1),
  add_pricing_card_v1: wrap<PricingCardV1Params>(buildPricingCardV1),
  add_profile_header_v1: wrap<ProfileHeaderV1Params>(buildProfileHeaderV1),
  add_progress_bar_v1: wrap<ProgressBarV1Params>(buildProgressBarV1),
  add_quote_block_v1: wrap<QuoteBlockV1Params>(buildQuoteBlockV1),
  add_radio_v1: wrap<RadioV1Params>(buildRadioV1),
  add_range_slider_v1: wrap<RangeSliderV1Params>(buildRangeSliderV1),
  add_rating_stars_v1: wrap<RatingStarsV1Params>(buildRatingStarsV1),
  add_search_bar_v1: wrap<SearchBarV1Params>(buildSearchBarV1),
  add_section_header_v1: wrap<SectionHeaderV1Params>(buildSectionHeaderV1),
