...
export const DESIGN_TOOL_DEFINITIONS = [
  {
    ...
    description:
      ...
      'planning (layered workflow guide), elements (N-tool element-tool family — 12 tools covering rows ' +
      '[card/metric/nav_chip/stat_grid], containers [bottom_nav/top_nav_bar/section_header/icon_button/activity_ring], ' +
      'atoms [divider/badge/avatar] — decision tree + PREFER/FALLBACK rules + composition pattern). ' +
