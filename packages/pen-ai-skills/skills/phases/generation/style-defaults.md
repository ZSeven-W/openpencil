...
- 默认使用 clean light marketing style，除非用户明确要求 dark/cyber/terminal。
...
- Caption: 13-14px — "Inter" (400), lineHeight 1.4
  SHAPES：cornerRadius 8-14。Subtle shadows。通过 spacing 和 contrast 建立清晰 hierarchy。
  LANDING PAGES：hero 80-120px padding，交替 section backgrounds，cards cornerRadius 12-16，centered content ~1040-1160px。
